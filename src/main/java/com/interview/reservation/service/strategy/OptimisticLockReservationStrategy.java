...
public class OptimisticLockReservationStrategy implements ReservationStrategy {
     ...
     *
     * <p><b>기본값 5에 실측 근거는 없다 — 재시도 상한의 관례값이다.</b> 통제된 HTTP 측정은 이 값의
     * 한계를 보여준다: 정원 100·경쟁 120에서 상한 5는 중앙값 기준 <b>107건을 503으로 끝내고
     * 13석만</b> 채웠다. 상한 20은 100석을 채웠지만 평균 응답 중앙값 520ms·TPS 137.6으로,
     * 같은 조건의 조건부 UPDATE(136ms·TPS 582.5)보다 비용이 컸다.
     *
