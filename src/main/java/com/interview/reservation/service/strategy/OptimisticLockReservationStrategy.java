...
public class OptimisticLockReservationStrategy implements ReservationStrategy {
     ...
     *
     * <p><b>기본값 5에 실측 근거는 없다 — 재시도 상한의 관례값이다.</b> 방법론 v2의 정원 100·경쟁
     * 120에서 Phase A의 상한 5는 확정 예약 중앙값 <b>12</b>, 재시도 소진 <b>108건</b>
     * (103–110)이었다. Phase B의 상한 20은 100석을 채웠지만 평균 응답 중앙값
     * 483ms(461–531)·버스트 TPS 139.5(131.3–149.1)였고, 같은 Phase의 조건부 UPDATE는
     * 126ms(119–142)·563.4 TPS(526.3–594.1)였다. 상한 5와 20은 서로 다른 앱 기동에서 얻은
     * 민감도 분석이므로 직접 짝비교하지 않고 각각 같은 Phase의 대조군과 비교한다.
     *
     * <p>즉 측정한 두 Phase에서는 <b>고를 만한 좋은 값이 관측되지 않았다</b>. 상한 5는 같은
     * Phase 대조군보다 가용성을, 상한 20은 같은 Phase 대조군보다 응답시간을 내줬다. 이 "정답 없는
     * 튜닝"이 ⑤가 치르는 비용의 일부이며, ⑤를 채택하지 않는 근거 중 하나다
     * (docs/STEP2-OPTIMISTIC-LOCK.md 1절·5-2절).
     */
