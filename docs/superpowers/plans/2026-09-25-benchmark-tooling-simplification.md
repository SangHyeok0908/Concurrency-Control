...
**Spec:** `docs/superpowers/specs/2026-09-25-benchmark-tooling-simplification-design.md`
...
```bash
rg -n 'benchmark\.sh|benchmark_schedule|benchmark_schema|gatling_binary_log|parse_gatling_report|parse_optimistic_metrics|promote_benchmark_campaign|validate_benchmark_campaign|validate_benchmark_environment|validate_phase_b_input|write_benchmark_row' README.md PROJECT_PLAN.md docs --glob '!docs/benchmark/campaigns/**' --glob '!docs/benchmark/2026-09-24-controlled-run.md' --glob '!docs/superpowers/specs/2026-09-25-benchmark-tooling-simplification-design.md' --glob '!docs/superpowers/plans/2026-09-25-benchmark-tooling-simplification.md'
```
