...
| 방식 | 확정 예약 중앙값 | 오버부킹 최댓값 | 중복 최댓값 | KO 중앙값 | 실행별 평균 응답의 중앙값 (min–max) | 실행별 p95의 중앙값 (min–max) | 버스트 TPS의 중앙값 (min–max) | n |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
